      ...
      <div className="hero bg-base-200 bg-blend-overlay">
        <div className="hero-content text-center">
          <div className="max-w-xl">
            <h1 className="text-6xl font-bold max-md:text-4xl text-accent-content">Best Hardawres Shop Ever !</h1>
            <p className="py-6 text-2xl max-md:text-lg text-accent-content">
                We provide the best quality hardware tools for your daily needs.
            </p>
